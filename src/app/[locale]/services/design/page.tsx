...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'meta.serviceDesign' })

  return {
    title: { absolute: t('title') },
    description: t('description'),
    alternates: buildAlternates(locale, '/services/design'),
...
export default async function DesignPage({
  ...
  void params
  const t    = await getTranslations('serviceDesign')
